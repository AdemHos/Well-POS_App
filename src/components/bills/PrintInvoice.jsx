...
const PrintInvoice = ({isModalOpen,setIsModalOpen}) => {
  ...
  return (
    <div>
      <Modal title='Fatura Yazdır' open={isModalOpen} footer={false} onCancel={() => setIsModalOpen(false)}
      width={800} >
        {/* Invoice Section */}
         ...
         <div className='max-w-5xl mx-auto bg-white px-6'>
            <article className='overflow-hidden'>
                ...
                <div className="logo my-6">
                    <h2 className='font-bold text-4xl'><span className='text-blue-500 italic font-light'>Well</span>POS</h2>
                </div>
                {/* Invoice Details */}
                <div className='invoice-details'>
                  <div className='grid sm:grid-cols-4 grid-cols-3 gap-12 '>
                    ...
                    <div className='text-sm text-slate-500'>
                        ...
                        <p className='font-bold text-slate-800'>Fatura Numarası:</p>
                        <p>00044321</p>
                        </div>
                        <div>

                        <p className='font-bold text-slate-800 mt-2'>Veriliş Tarihi:</p>
                        <p>18/04/2025</p>
                        </div>
                ...
                <div className="invoice-table-area mt-8">
                    <table className='min-w-full divide-y divide-slate-700 overflow-hidden'>
                        <thead>
                            <tr className='border-b border-slate-300'>
                                ...
                                <th scope='col' colSpan={'4'} className='py-3.5  text-left 
                        ...
                        <tbody>
                            <tr className='border-b border-slate-300'>
                                ...
                                <td className='py-4 sm:table-cell hidden  '>
                                   ...
                                   <span className='font-medium'>Armut</span>
                                   <span className='text-xs inline-block sm:hidden'>Birim Fiyatı</span>
                                   </div>
                                </td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th className='text-right pt-4 sm:hidden' colSpan={'4'} scope='row'>
                                    <span className='font-normal text-slate-700'>Ara Toplam</span>
                                </th>
                            ...
                            <tr>
                                ...
                                <th className='text-right pt-4' colSpan={'4'} scope='row'>
                                    <span className='font-normal text-red-600'>+5.43₺</span>
                                </th>
                            </tr>
                            <tr>
                                <th className='text-right pt-4 sm:table-cell hidden' colSpan={'4'} scope='row'>
                                ...
                                <th className='text-right pt-4' colSpan={'4'} scope='row'>
                                    <span className='font-normal text-slate-700'>55₺</span>
                                </th>
                            </tr>
                        </tfoot>
                    </table>
                    <div className="py-9">
                        ...
                        <p className='text-sm font-light text-slate-800'>Ödeme koşulları 14 gündür. Paketlenmemiş Borçların Geç Ödeme Yasası 
                            000'a göre, serbest çalışanların borçlarını ödememesi durumunda
                            00.00 gecikme ücreti talep etme hakkına sahip olduklarını ve bu noktada
                            bu ücrete ek olarak yeni bir fatura sunulacağını lütfen unutmayın.
                            Revize faturanın 14 gün içinde ödenmemesi durumunda vadesi geçmiş
                            hesaba ek faiz ve %8 yasal oran artı %0.5 Bank of England tabanlı
                            olmak üzere toplam %8.5 uygulanacaktır.
